    ...
    <section id="cta" className="relative overflow-hidden py-24 sm:py-32">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <motion.div
          ...
          className="absolute left-1/2 top-1/2 h-[420px] w-[720px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(255,122,26,0.24),transparent_62%)] blur-3xl"
        />
        <Constellation />
      </div>
